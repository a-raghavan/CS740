...
for i in range(iterations):
    ...
    subprocess.run(["python3", "/home/dsmith7789/University_of_Wisconsin/Github/CS740/dropbox_upload.py", file_size])
    ...
    subprocess.run(["python3", "/home/dsmith7789/University_of_Wisconsin/Github/CS740/dropbox_download.py", file_size])
    print("\n\nFinished Uploading Files.")
    print("\n\nClearing Dropbox directory...")
    subprocess.run(["python3", "/home/dsmith7789/University_of_Wisconsin/Github/CS740/clear_dropbox_directory.py"])
